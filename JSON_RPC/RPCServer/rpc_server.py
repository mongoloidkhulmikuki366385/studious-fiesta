...
from rpcserver_dispatcher import RPCDispatcher
from rpcserver_servertransport import ZmqServerTransport
from . import *
...
class RPCServerWrapper:
    def __init__(self, transport, publisher=None, ctx=None, protocol=None, dispatcher=None):
        ...
        if isinstance(transport, ZmqServerTransport):
            ...
            if 'tcp' not in str(transport):
                transport = "tcp://127.0.0.1:" + str(transport)
